     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select name="editarRol" class="form-control" required>
            ...
            <option value="0"<?= $_SESSION["rol"] == 0 ? ' selected' : '' ?>>Administrador</option>
            <option value="1"<?= $_SESSION["rol"] == 1 ? ' selected' : '' ?>>Editor</option>
       ...
       <div class="form-group text-center">
          ...
          <img src="<?= $_SESSION["photo"]; ?>" width="20%" class="img-circle">

           <input type="hidden" value="<?= $_SESSION["photo"]; ?>" name="editarPhoto">
