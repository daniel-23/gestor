...
class GestorArticulos{
	...
	public static function mostrarImagenController($datos){
		...
		if($ancho < 800 || $alto < 400){
			...
			$ruta = "../../Vista/Imagenes/articulos/temp/articulo".$aleatorio.".jpg";
	...
	public function mostrarArticulosController(){
		...
		foreach($respuesta as $row => $item) {
			...
			echo ' <li id="'.$item["id"].'" class="bloqueArticulo">
					...
					<a href="articulos-idBorrar-'.$item["id"].'">
	...
	public function borrarArticuloController(){
		...
		if(isset($_GET["idBorrar"])){
			...
			$rutaImagen = GestorArticulosModel::rutaimgmodel($_GET["idBorrar"], "articulos");

			unlink($rutaImagen["ruta"]);
