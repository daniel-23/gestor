...
class SuscriptoresController{
	...
	public function mostrarSuscriptoresController(){
		...
		foreach ($respuesta as $row => $item){
			...
			echo '<tr>
			        ...
			        <td>'.$item["email"].'</td>
			        <td>
			        	<a href="suscriptores-idBorrar-'.$item["id"].'"><span class="btn btn-danger fa fa-times quitarSuscriptor"></span></a>
			        </td>
			        <td>
			        </td>
			      </tr>';
	...
	public function suscriptoresSinRevisarController(){
		...
		if ($respuesta['cantidad'] > 0) {
			echo '<span>'.$respuesta["cantidad"].'</span>';
		}
	...
	#------------------------------------------------------------
	public function suscriptoresRevisadosController(){


		$respuesta = SuscriptoresModel::suscriptoresRevisadosModel("suscriptores");
